...
exports.connectToNetwork = async function (req, res, next) {
  try {
    ...
    const ccpPath = path.resolve(__dirname, '..', 'ledger', 'network', 'fabric-network', 'organizations', 'peerOrganizations', 'org1.example.com', 'connection-org1.json');
    ...
    req.contract = network.getContract(CONTRACT);
    next();
